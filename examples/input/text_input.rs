...
fn toggle_ime(
    ...
    mut text: Query<&mut Text, With<UiSize>>,
) {
...
fn listen_ime_events(
    ...
    mut status_text: Query<&mut Text, With<UiSize>>,
    mut edit_text: Query<&mut Text, (Without<UiSize>, Without<Bubble>)>,
) {
...
fn listen_keyboard_input_events(
    ...
    mut edit_text: Query<(Entity, &mut Text), (Without<UiSize>, Without<Bubble>)>,
) {
    for event in events.iter() {
