...
fn toggle_ime(
    ...
    mut text: Query<&mut Text, With<ComputedLayout>>,
) {
...
fn listen_ime_events(
    ...
    mut status_text: Query<&mut Text, With<ComputedLayout>>,
    mut edit_text: Query<&mut Text, (Without<ComputedLayout>, Without<Bubble>)>,
) {
...
fn listen_keyboard_input_events(
    ...
    mut edit_text: Query<(Entity, &mut Text), (Without<ComputedLayout>, Without<Bubble>)>,
) {
    for event in events.read() {
