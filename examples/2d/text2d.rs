...
fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    commands.spawn((
        Text2dBundle {
            text: TextBlock::from_section("translation", text_style.clone())
    ...
    commands.spawn((
        Text2dBundle {
            text: TextBlock::from_section("rotation", text_style.clone()).with_alignment(text_alignment),
            ..default()
        },
        AnimateRotation,
    ));
    ...
    commands.spawn((
        Text2dBundle {
            text: TextBlock::from_section("scale", text_style.clone()).with_alignment(text_alignment),
            ..default()
        },
        AnimateScale,
    ));
    ...
    commands.spawn(Text2dBundle {
        text: TextBlock::from_section("this text wraps in the box", text_style),
