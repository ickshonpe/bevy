...
[Many Buttons](../examples/stress_tests/many_buttons.rs) | Tests a UI with a lot of buttons
[Many UI Rects](../examples/stress_tests/many_uirects.rs) | Tests rendering of many rectangles with the UI
