...
pub fn update_clipping_system(
    ...
    root_node_query: Query<Entity, (With<UiSize>, Without<Parent>)>,
    mut node_query: Query<(&UiSize, &GlobalTransform, &Style, Option<&mut CalculatedClip>)>,
...
fn update_clipping(
    ...
    children_query: &Query<&Children>,
    node_query: &mut Query<(&UiSize, &GlobalTransform, &Style, Option<&mut CalculatedClip>)>,
    entity: Entity,
