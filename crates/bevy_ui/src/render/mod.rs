        ...
        .add_systems(
            ...
            (
                ...
                extract_uinode_borders
                    .in_set(RenderUiSystem::ExtractBorders)
                    .after(RenderUiSystem::ExtractNode),
                #[cfg(feature = "bevy_text")]
                extract_text_uinodes
                    .in_set(RenderUiSystem::ExtractText)
                    .after(RenderUiSystem::ExtractBorders),
            ),
        )
        .add_systems(
            Render,
...
pub fn extract_uinodes(
    ...
    for (stack_index, entity) in ui_stack.uinodes.iter().enumerate() {
        ...
        )) = uinode_query.get(*entity)
        {
            ...
            extracted_uinodes.uinodes.insert(entity, extracted_node);
        }
    }
}
        ...
        for mut ui_phase in &mut phases {
            ...
            for item_index in 0..ui_phase.items.len() {
                ...
                if let Some(extracted_uinode) = extracted_uinodes.uinodes.get(item.entity) {
                    ...
                    let uvs = if mode == shader_flags::UNTEXTURED {
