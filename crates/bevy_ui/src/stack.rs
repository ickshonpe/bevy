...
pub fn ui_stack_system(
    ...
    zindex_query: Query<&ZIndex, With<ComputedLayout>>,
...
mod tests {
    ...
    use crate::{ComputedLayout, UiStack, ZIndex};
    ...
    fn node_with_zindex(name: &'static str, z_index: ZIndex) -> (Label, ComputedLayout, ZIndex) {
        (Label(name), ComputedLayout::default(), z_index)
    }

    fn node_without_zindex(name: &'static str) -> (Label, ComputedLayout) {
        (Label(name), ComputedLayout::default())
    }
