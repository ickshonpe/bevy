...
If you need them, these range can be retrieved using `visual_clusters` by mapping each cluster's `text_range` to its corresponding `Glyph`(s), but this approach is fragile.
